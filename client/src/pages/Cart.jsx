                    ...
                    <div key={product._id} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        <div className="flex items-center md:gap-6 gap-3">
                            ...
                            <div>
                                ...
                                {!inStock && (
                                    <p className="text-xs font-semibold text-amber-800 mt-1">Out of stock — remove or wait for restock</p>
                                )}
                                        ...
                                        <div className='flex items-center gap-2'>
                                            ...
                                            <div className='flex items-center rounded-xl border border-gray-300 overflow-hidden text-sm'>
                                                <button
                                                    ...
                                                    className={`px-3 py-1 transition ${!inStock || product.quantity <= 1 ? 'text-gray-300 cursor-not-allowed' : 'text-gray-700 hover:bg-gray-100'}`}
                                                >
                                                    -
                                                </button>
                                                <span className='px-3 py-1 min-w-[2.25rem] text-center text-gray-700'>{product.quantity}</span>
                                                <button
                                                    type='button'
                                                    disabled={!inStock || product.quantity >= (product.stock ?? 0)}
                                                    onClick={() => {
                                                    ...
                                                    className={`px-3 py-1 transition ${!inStock || product.quantity >= (product.stock ?? 0) ? 'text-gray-300 cursor-not-allowed' : 'text-gray-700 hover:bg-gray-100'}`}
                                                >
                                                    +
                                                </button>
                                            </div>
                        ...
                        <button type="button" onClick={()=> removeFromCart(product._id)} className="cursor-pointer mx-auto">
